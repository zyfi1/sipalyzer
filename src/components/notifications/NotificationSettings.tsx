  ...
  return (
    <div className="h-full min-h-0 space-y-3 p-4">
      ...
      <div className="space-y-2">
        <h3 className="text-sm font-semibold px-1">Preview</h3>
      ...
      {/* Display Options */}
      <div className="space-y-2">
        <h3 className="text-sm font-semibold px-1">Display</h3>
      ...
      {/* Behavior */}
      <div className="space-y-2">
        <h3 className="text-sm font-semibold px-1">Behavior</h3>
        <div className="ui-panel-shell rounded-md divide-y divide-border/30">
          <div className="flex items-center justify-between px-3 py-2.5">
            <div className="space-y-0.5">
      ...
      {/* History */}
      <div className="space-y-2">
        <h3 className="text-sm font-semibold px-1">History</h3>
      ...
      {/* Per-Source Muting (only collapsible section) */}
      <div className="space-y-2">
        <button
          type="button"
        ...
        >
          ...
          <ChevronRight
            className={cn(
              ...
              sourceExpanded && "rotate-90 text-foreground",
            )}
          />
        </button>
        {sourceExpanded && (
